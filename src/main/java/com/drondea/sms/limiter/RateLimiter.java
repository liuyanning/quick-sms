...
import com.drondea.sms.limiter.SmoothRateLimiter.SmoothBursty;
import com.drondea.sms.limiter.SmoothRateLimiter.SmoothWarmingUp;
...
import static com.drondea.sms.limiter.Internal.toNanosSaturated;
...
public abstract class RateLimiter {
     ...
     * @return
     */
    public long reserveTime(int permits) {
        checkPermits(permits);
        synchronized (mutex()) {
            return reserveAndGetWaitLength(permits, stopwatch.readMicros());
        }
