...
public class Cmpp20MessageCodec extends MessageToMessageCodec<ByteBuf, AbstractCmppMessage> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Cmpp20MessageCodec.class);

    private static class CmppMessageCodecHolder {
        private final static Cmpp20MessageCodec instance = new Cmpp20MessageCodec();
    }
    ...
    protected void encode(ChannelHandlerContext ctx, AbstractCmppMessage msg, List<Object> out) throws Exception {
        ...
        //消息总长度
        int totalLength = msg.getBodyLength20() + msg.getHeaderLength();
