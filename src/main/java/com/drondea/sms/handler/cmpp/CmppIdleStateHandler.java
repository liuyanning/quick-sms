...
public class CmppIdleStateHandler extends ChannelDuplexHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CmppIdleStateHandler.class);
        ...
        if (evt instanceof IdleStateEvent) {
            ...
            if (e.state() == IdleState.ALL_IDLE) {
                ...
                if (ctx.channel().isActive()) {
                    CmppActiveTestRequestMessage msg = new CmppActiveTestRequestMessage();
