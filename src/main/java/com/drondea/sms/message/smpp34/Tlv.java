...
public class Tlv {
    ...
    /**
     * tagName仅用于记录/调试，它显示在toString()方法中。
     *
     * @param tag
     * @param value
     * @param tagName
    ...
    public String getValueAsString(String charsetName) throws Exception {
        if (this.value == null) {
            return null;
        }
        ...
        try {
            ...
            throw new Exception("unsupported charset " + e.getMessage());
        }
    }
