...
public class SgipSubmitResponseMessageCodec implements ICodec {
    ...
    private final Logger logger = LoggerFactory.getLogger(SgipSubmitResponseMessageCodec.class);

    @Override
    public IMessage decode(IHeader header, ByteBuf bodyBuffer) {
        SgipSubmitResponseMessage message = new SgipSubmitResponseMessage((SgipHeader) header);
    ...
    public ByteBuf encode(IMessage msg, ByteBuf bodyBuffer) {
        SgipSubmitResponseMessage message = (SgipSubmitResponseMessage) msg;
