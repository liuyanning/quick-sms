...
import com.drondea.sms.handler.smpp.*;
...
public class SmppConstants {
    ...
    public final static SmppServerSessionFilterHandler SERVER_SESSION_FILTER_HANDLER = new SmppServerSessionFilterHandler();

    public final static SmppEnquireLinkRequestMessageHandler ENQUIRE_LINK_REQUEST_HANDLER = new SmppEnquireLinkRequestMessageHandler();
    public final static SmppEnquireLinkResponseMessageHandler ENQUIRE_LINK_RESPONSE_HANDLER = new SmppEnquireLinkResponseMessageHandler();
    public static final SmppIdleStateHandler IDLE_STATE_HANDLER = new SmppIdleStateHandler();
    public final static UserEventHandler SMPP_USER_EVENT_HANDLER = new UserEventHandler();

    public final static SmppSubmitLongMessageHandler SUBMIT_LONG_MESSAGE_HANDLER = new SmppSubmitLongMessageHandler();
    public final static SmppDeliverLongMessageHandler DELIVER_LONG_MESSAGE_HANDLER = new SmppDeliverLongMessageHandler();

    public final static SmppTerminateRequestMessageHandler TERMINATE_REQUEST_MESSAGE_HANDLER = new SmppTerminateRequestMessageHandler();
    public final static SmppTerminateResponseMessageHandler TERMINATE_RESPONSE_MESSAGE_HANDLER = new SmppTerminateResponseMessageHandler();


    public static final AttributeKey<ChannelSession> NETTY_SESSION_KEY = AttributeKey.valueOf("netty.session");

    public final static SmppSmsDcs DEFAULT_MSG_FMT = SmppSmsDcs.getGeneralDataCodingDcs(SmsAlphabet.ASCII);
...
//    public static final Address EMPTY_ADDRESS = new Address();
    ...
    public static final short VERSION_3_3 = 0x33;
    public static final short VERSION_3_4 = 0x34;
    public static final short VERSION_5_0 = 0x50;
