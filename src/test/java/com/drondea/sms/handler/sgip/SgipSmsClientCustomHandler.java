 ...
 **/
public class SgipSmsClientCustomHandler extends ICustomHandler {

    private static final Logger logger = LoggerFactory.getLogger(SgipSmsClientCustomHandler.class);
    ...
    public void fireUserLogin(Channel channel, ChannelSession channelSession) {
        ...
        synchronized (channelSession.getConfiguration()) {
            channelSession.getConfiguration().notifyAll();
        }
    }
